...
function Shape() {
    ...
    return (
        ...
        <div
            className={`absolute top-0 bottom-0 right-0 left-0 w-full h-full bg-black-alpha-50 z-40 invisible opacity-0 ${$isHover && "!visible !opacity-100"} ${$showShoppingCart && "!visible !opacity-100"} ${$isOpenMobileMenu && "!visible !opacity-100"}`}
            onClick={() => {
